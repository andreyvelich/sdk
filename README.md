...
- [2026/03] The Kubeflow SDK v0.4 is officially released with SparkClient and ModelRegistryClient. Check out
  [the announcement blog post](https://blog.kubeflow.org/kubeflow-sdk-0.4.0-release/).
